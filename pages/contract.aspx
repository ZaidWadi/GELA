...
<body>
    ...
    <br /><br />مكتوبة:_________________________________________________________________
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
    ...
    يلتزم الفريق الأول بالتسليم النهائي للأعمال المتفق عليها حسب المواصفات المقدمه بعرض السعر و بعد استلام  الدفعة الأولى 
                  ...
                  <asp:TableRow>
                    ...
                    <asp:TableCell>
    و حيث ان مدة تنفبذ الاعمال المطلوبة هي (_______يوم) واي تغيرات يتم طلبها من قبل الفريق الثاني سواءا بالمواصفات او الالوان يعتبر تمديد تلقائي للعقد و حسب حجم التغير من وجهة نظر الفريق الاول او في حال طلب الفريق الثاني أي أعمال اضافية بعد توقيع العقد فإنها لا تدخل في القيمة الإجمالية للعقد و لا مدة التوريد حيث تضاف القيمة على إجمالي العقد كذلك مدة التسليم النهائي لكامل المنتجات .
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
