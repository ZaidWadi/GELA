...
namespace GELA_DB.pages
{
    public partial class WebForm19 : System.Web.UI.Page
    {
        ...
        protected void Tab3_Click(object sender, EventArgs e)
        {
            ...
            Tab2.CssClass = "Initial_button";
            Tab4.CssClass = "Initial_button";
            Tab5.CssClass = "Initial_button";
            Tab6.CssClass = "Initial_button";
            Tab7.CssClass = "Initial_button";
            material_views.ActiveViewIndex = 2;
        }

        protected void Tab4_Click(object sender, EventArgs e)
        {
            Tab4.CssClass = "Clicked_button";
            Tab1.CssClass = "Initial_button";
            Tab2.CssClass = "Initial_button";
        ...
        {
            string popup = "window.open ('add_wood.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }

        protected void btn_add_acc_Click(object sender, EventArgs e)
        {
            string popup = "window.open ('add_acc.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }

        protected void btn_add_device_Click(object sender, EventArgs e)
        {
            string popup = "window.open ('add_device.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }

        protected void btn_add_granite_Click(object sender, EventArgs e)
        {
            string popup = "window.open ('add_granite.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }
        ...
        {
            string popup = "window.open ('add_lighting.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }

        protected void btn_add_sink_Click(object sender, EventArgs e)
        {
            string popup = "window.open ('add_sink.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }

        protected void btn_add_faucet_Click(object sender, EventArgs e)
        {
            string popup = "window.open ('add_faucet.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }
