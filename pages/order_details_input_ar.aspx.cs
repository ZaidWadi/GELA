    ...
    public partial class WebForm49 : System.Web.UI.Page
    {
        ...
        protected void btn_add_cabinet_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                SqlCommand cmd_add = new SqlCommand("INSERT INTO dbo.entry_tbl_order (project_no,product,width,accessories,devices,lighting,lighting_position,lighting_location_type,quantity) VALUES(@project_ID,@product,@width,@accessories,@devices,@lighting,@lighting_position,@lighting_location,@quantity)", con);
