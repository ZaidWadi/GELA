<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_info_input.aspx.cs" Inherits="GELA_DB.pages.WebForm1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Label ID="lbl_customer_ID" runat="server"></asp:Label>
                ...
                <tr>
                     <td>
            <asp:Label ID="lbl_title" runat="server">Full Name: </asp:Label>
