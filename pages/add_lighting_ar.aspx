<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_lighting_ar.aspx.cs" Inherits="GELA_DB.pages.WebForm32" %>
       ...
       <div style="background-color:whitesmoke;">
            <asp:Table runat="server" CellSpacing="10">
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:TextBox ID="txtbx_light_name" runat="server"></asp:TextBox>
                    </asp:TableCell>
                     <asp:TableCell>
                        السعر:
                    </asp:TableCell>
