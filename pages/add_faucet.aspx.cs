...
namespace GELA_DB.pages
{
    public partial class WebForm27 : System.Web.UI.Page
    {
        ...
        protected void btn_done_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd_add_price = new SqlCommand("INSERT INTO dbo.fxd_tbl_faucets (faucet_name,faucet_price) VALUES(@name,@price)", con);
            cmd_add_price.Parameters.AddWithValue("@name", txtbx_faucet_name.Text);
