...
namespace GELA_DB.pages
{
    ...
    public partial class WebForm22 : System.Web.UI.Page
    {
        ...
        {
            if (Tab2.CssClass == "Clicked_button")
            {
                Tab2.CssClass = "Initial_button";
                design_views.ActiveViewIndex = 0;
            }
        ...
        protected void btn_new_project_Click(object sender, EventArgs e)
        {
            ...
            {
                string popup = "window.open ('project_data_input.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
        ...
        {
            string popup = "window.open ('lateness_report.aspx', 'popup_window', 'width=300,height=100,left=100,top=100,resizable=yes');";
            ClientScript.RegisterStartupScript(GetType(), "script", popup, true);
        }
